...
export interface ApiCateogoryCateogory extends Schema.CollectionType {
  collectionName: 'cateogories'
  info: {
    singularName: 'cateogory'
    pluralName: 'cateogories'
